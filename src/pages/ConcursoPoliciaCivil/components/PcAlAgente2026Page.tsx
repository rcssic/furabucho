        ...
        <div className="cargo-glass-wrapper">
            <div className="cargo-content-max">
                ...
                <header className="cargo-header">
                    ...
                    <p>Agente de Polícia Civil (Cargo 1)</p>
                    <a 
                ...
                <div className="glass-grid">
                    ...
                    <div className="glass-card">
                        ...
                        <ul className="glass-data-list">
                            <li><span>Ampla Concorrência (AC)</span> <strong>48 Imediatas | 48 CR</strong></li>
                            <li><span>Pessoas com Deficiência (PcD)</span> <strong>4 Imediatas | 4 CR</strong></li>
                            <li><span>Cotas (PPIQ - 20%)</span> <strong>13 Imediatas | 13 CR</strong></li>
                            <li style={{ borderTop: '1px solid rgba(255,255,255,0.1)', paddingTop: '12px', marginTop: '4px' }}>
                                <span><strong>Total Geral</strong></span> <strong>130 Vagas (65 Imediatas + 65 CR)</strong>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div className="glass-card">
                        ...
                        <ul className="glass-data-list">
                            <li><span>Ampla Concorrência (AC)</span> <strong>288 redações corrigidas</strong></li>
                            <li><span>Pessoas com Deficiência (PcD)</span> <strong>24 redações corrigidas</strong></li>
                            <li><span>Cotas (PPIQ)</span> <strong>78 redações corrigidas</strong></li>
                            <li style={{ borderTop: '1px solid rgba(255,255,255,0.1)', paddingTop: '12px', marginTop: '4px' }}>
                                <span><strong>Total Corrigido</strong></span> <strong>390 discursivas corrigidas</strong>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div className="glass-card">
                        ...
                        <ul className="glass-data-list">
                            ...
                            <li><span>Habilitação</span> <strong>CNH Categoria B ou superior</strong></li>
                    ...
                    <div className="glass-card full padding-zero">
                        ...
                        ========================================= */}
                        <div className="area-badge" style={{ marginTop: '20px' }}>CONHECIMENTOS ESPECÍFICOS - AGENTE (70 Questões)</div>
                        ...
                        <SubjectAccordion title="NOÇÕES DE DIREITO CONSTITUCIONAL">
                            <div className="indent-level-1">1 Constituição Federal de 1988.</div>
                        ...
                        <SubjectAccordion title="NOÇÕES DE DIREITO ADMINISTRATIVO">
                            ...
                            <div className="indent-level-1">7 Responsabilidade civil do State.</div>
                            <div className="indent-level-2">7.1 Responsabilidade por ato comissivo do Estado.</div>
                            <div className="indent-level-2">7.2 Responsabilidade por omissão do Estado.</div>
                        ...
                        <SubjectAccordion title="LEGISLAÇÃO PENAL ESPECIAL">
                            ...
                            <div className="indent-level-1">12 Crimes de responsabilidade (Decreto-Lei nº 201/1967 e suas alterações, Lei nº 1.079/1950 e suas alterações).</div>
                        ...
                        <SubjectAccordion title="ESTATÍSTICA E ANÁLISE DE DADOS">
                            ...
                            <div className="indent-level-1">5 Linguagem Python: sintaxe, variáveis, tipos de dados e estruturas de controle de fluxo. Estruturas de dados, funções e arquivos. Bibliotecas: NLTK, Tensor Flow, Pandas, Numpy, Sklearn, Scipy.</div>
                        </SubjectAccordion>
