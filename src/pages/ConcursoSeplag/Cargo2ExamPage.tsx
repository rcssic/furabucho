...
export default function Cargo2ExamPage() {
    return (
        <div className="glass-container">
            <header className="glass-header">
                ...
                <a 
                    ...
                    href="http://www.cebraspe.org.br/concursos/seplag_al_26_especialista" 
                    target="_blank" 
                    rel="noreferrer"
                >
            ...
            <div className="glass-grid">
                <div className="glass-card">
                    ...
                    <ul className="glass-list">
                        <li><strong>Remuneração:</strong> R$ 5.767,15.</li>
                        <li><strong>Jornada de Trabalho:</strong> 40 horas semanais.</li>
                        <li><strong>Requisitos Básicos:</strong> Diploma de graduação em Análise e Desenvolvimento de Sistemas, Ciência da Computação, Sistemas de Informação ou Tecnologia da Informação.</li>
                        <li><strong>Taxa de Inscrição:</strong> R$ 120,00.</li>
                        <li><strong>Banca Examinadora:</strong> Cebraspe.</li>
                    </ul>
                </div>
                ...
                <div className="glass-card">
                    ...
                    <ul className="glass-list">
                        <li><strong>Inscrições:</strong> 09/03/2026 a 08/04/2026.</li>
                        <li><strong>Pagamento da Taxa:</strong> Até 10/04/2026.</li>
                        <li><strong>Locais de Prova:</strong> 15/05/2026.</li>
                        <li><strong>Data das Provas:</strong> 31/05/2026 (Turno da Tarde).</li>
                        <li><strong>Gabarito Preliminar:</strong> 11/06/2026.</li>
                        <li><strong>Resultado Provisório e Final (Objetiva):</strong> 08/07/2026.</li>
                    </ul>
                </div>
                ...
                <div className="glass-card">
                    ...
                    <ul className="glass-list">
                        <li><strong>Método de Julgamento:</strong> CERTO ou ERRADO (Método Cespe).</li>
                        <li><strong>Penalidade:</strong> Marcação em discordância com o gabarito oficial resulta em pontuação negativa.</li>
                        <li><strong>Duração:</strong> 4 horas e 30 minutos.</li>
                        <li><strong>Prova Objetiva (P1 e P2):</strong> 50 itens de Conhecimentos Básicos e 70 itens de Específicos.</li>
                        <li><strong>Prova Discursiva (P3):</strong> Redação dissertativa de até 30 linhas sobre atualidades, valendo 30,00 pontos (necessário caneta preta de material transparente).</li>
                    </ul>
                </div>
                ...
                <div className="glass-card full-width">
                    ...
                    <div className="syllabus-container">
                        ...
                        <div className="knowledge-area">
                            <div className="knowledge-area-title">CONHECIMENTOS BÁSICOS (50 Itens)</div>

                            <div className="subject-title">LÍNGUA PORTUGUESA</div>
                            ...
                            <div className="subject-title">TECNOLOGIA DA INFORMAÇÃO</div>
                            ...
                            <div className="subject-title">ÉTICA E COMPLIANCE NA ADMINISTRAÇÃO PÚBLICA</div>
                            ...
                            <div className="subject-title">CONHECIMENTOS DO ESTADO DE ALAGOAS</div>
                            ...
                            <div className="subject-title">ATUALIDADES (SOMENTE PARA A PROVA DISCURSIVA)</div>
                        ...
                        <div className="knowledge-area">
                            <div className="knowledge-area-title">CONHECIMENTOS ESPECÍFICOS - CARGO 2 (70 Itens)</div>

                            <div className="subject-title">ANÁLISE DE SISTEMAS</div>
                            ...
                            <div className="subject-title">DESENVOLVIMENTO DE SISTEMAS</div>
                            ...
                            <div className="subject-title">BANCOS DE DADOS</div>
                            ...
                            <div className="subject-title">SEGURANÇA DA INFORMAÇÃO</div>
                            ...
                            <div className="subject-title">FISCALIZAÇÃO DE CONTRATOS DE TI</div>
